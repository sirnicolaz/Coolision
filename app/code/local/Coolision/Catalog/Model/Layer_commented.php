...
class Mage_Catalog_Model_Layer extends Varien_Object
{
     ...
     * @return string
     */
	/*Sta merda minaccia di non servire a nulla. Test eseguito: mettere un attributo settato di default, ovvero color=4, nella stringa _statekey. Il comportamento nell'atto di applicare un qualsiasi filtri di tipo colore non è cambiato.*/
