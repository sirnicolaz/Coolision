...
abstract class Mage_Catalog_Block_Layer_Filter_Abstract extends Mage_Core_Block_Template
{
    ...
    /* Funzione per prendere l'attribute code del filtro (SPOSTARE NEL POOL LOCALE) */   
    public function getAttributeCode()
    {
      return $this->_filter->getAttributeCode();
    }
    
    /* Funzione per recuperare lo stato della layered navigation attraverso la model del filtro (SPOSTARE NEL POOL LOCALE) */
    public function getState()
    {
      return $this->_filter->getLayer()->getState();
    }
